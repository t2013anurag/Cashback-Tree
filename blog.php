			...
			<div class="row content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="breadcrumbs">
                    	<p><a href="index.php">Home</a> <i class="icons icon-right-dir"></i> News &amp; Reviews</p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="blog-item">
                                ...
                                <a href="blog_post.php"><img src="img/blog/sample1.jpg" alt=""></a>
                                <div class="blog-info">
                                	<h3><a href="blog_post.php">Fusce euismod consequat ante</a></h3>
                                    <div class="blog-meta">
                    ...
                    <div class="row">    
                        <div class="col-lg-6 col-md-6 col-sm-12">
                        	<div class="blog-item">
                                ...
                                <a href="blog_post.php"><img src="img/blog/sample2.jpg" alt=""></a>
                                <div class="blog-info">
                                	<h3><a href="blog_post.php">Fusce euismod consequat ante</a></h3>
                                    <div class="blog-meta">
                                    	<span class="date"><i class="icons icon-clock"></i> 21 December 2012</span>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                        	<div class="blog-item">
                                ...
                                <a href="blog_post.php"><img src="img/blog/sample3.jpg" alt=""></a>
                                <div class="blog-info">
                                	<h3><a href="blog_post.php">Fusce euismod consequat ante</a></h3>
                                    <div class="blog-meta">
                                    	<span class="date"><i class="icons icon-clock"></i> 21 December 2012</span>
                   ...
                   <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                        	<div class="blog-item">
                                ...
                                <a href="blog_post.php"><img src="img/blog/sample4.jpg" alt=""></a>
                                <div class="blog-info">
                                	<h3><a href="blog_post.php">Fusce euismod consequat ante</a></h3>
                                    <div class="blog-meta">
                                    	<span class="date"><i class="icons icon-clock"></i> 21 December 2012</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                        	<div class="blog-item">
                                ...
                                <a href="blog_post.php"><img src="img/blog/sample5.jpg" alt=""></a>
                                <div class="blog-info">
                                	<h3><a href="blog_post.php">Fusce euismod consequat ante</a></h3>
                                    <div class="blog-meta">
                                    	<span class="date"><i class="icons icon-clock"></i> 21 December 2012</span>
					...
					<div id="main-footer">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-3 col-sm-6 twitter-widget">
                                ...
                                <a href="http://www.twitter.com/ShoppingSenseIn/" class="button blue small">Follow us</a>
							</div>
							<!-- /Like us on Twitter -->
							...
							<div class="col-lg-3 col-md-3 col-sm-6 contact-footer-info">
								<h4>Contact Us</h4>
								<ul>
									<li><i class="icons icon-location"></i> Swenews<br>VIT Vellore</li>
                                    <li><i class="icons icon-phone"></i> 9629771207</li>
									<li><i class="icons icon-mail-alt"></i><a href="mailto:mail@company.com"> info@shoppingsense.in</a></li>
									</ul>
							</div>
							<!-- /Contact Us -->
