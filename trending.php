			...
			<div class="row content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="breadcrumbs">
                    	<p><a href="index.php">Home</a> <i class="icons icon-right-dir"></i> Trending Offers</p>
                    </div>
                </div>
				...
				<section class="main-content col-lg-9 col-md-9 col-sm-9 col-lg-push-3 col-md-push-3 col-sm-push-3">
                   ...
                   <div class="row"> 
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 product">
                            ...
                            <div class="product-info">
                                   <!---Link Aise dete hain---->    
								<a href="index.php"> <span  class="price">$281.00</span></a>
                                <div class="rating readonly-rating" data-score="4"></div>
                            </div>
					...
					<div class="row sidebar-box purple">
						...
						<div class="col-lg-12 col-md-12 col-sm-12">
							...
							<div class="sidebar-box-content">
								<ul>
									<li><a href="#">Fashion <i class="icons icon-right-dir"></i></a>
